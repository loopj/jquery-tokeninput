...
$.TokenList = function (input, settings) {
  ...
  // Create a new text input an attach keyup events KKK
  var input_box = $(input)
  .css({
    outline: "none"
  })
  ...
  input_box.appendTo(input_token)
  init_list();
  ...
  function init_list () {
    settings.destination.children(".input-token").children("." + settings.classes.tokenDelete).click(function () {
...
//      .focus();
  ...
  function insert_token(id, value) {
    var this_token = $("<li><o>"+ value +"</p></li>")
    ...
    var dropdown_ul = $("<ul>")
      ...
      for(var i in results) {
        if (results.hasOwnProperty(i)) {
          var this_li = $("<li><a href='javascript:' >"+highlight_term(results[i].name, query)+"</a></li>")
//          var this_li = $("<li><a href='javascript:' title='" + results[i].name + "'>" + results[i].name +"</a></li>")
  ...
  function run_search(query) {
    ...
    if(cached_results) {
      ...
      $.ajax({ url: settings.url, context: document.body, success: callback, data: { q: query } })
    }
  }
};
